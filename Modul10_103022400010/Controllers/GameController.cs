...
using Modul10_103022400010.Models;
using System;

namespace Modul10_103022400010.Controllers
{
    [ApiController]
    ...
    public class GameController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<Game> PostGame([FromBody] Game newGame)
        {
            games.Add(newGame);
        ...
        [HttpPut("{index}")]
        public ActionResult<Game> PutGame([FromRoute] int index, [FromBody] Game inputGame)
        {
            if (index < 0 || index >= games.Count)
            {
            ...
            return Ok("Game " + games[index - 1].Nama);
        }
